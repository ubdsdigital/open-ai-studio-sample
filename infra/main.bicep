...
param searchIndexName string = '' // Changed from 'newindex' to 'api-index-script' UPDATE: This didn't change the app settings to api-script-index. Therefore app still used newindex as the souece
